...
const routes = [
  ...
  },
  {
    ...
    description: "今泉歯科医院（桐生市広沢町間ノ島291-5）へのアクセス・診療時間。駐車場10台完備、昭和橋バス停から徒歩2分。土曜も診療。みどり市・笠懸・新里、太田・足利方面からもどうぞ。",
  },
  {
    path: "/faq",
    title: "よくある質問（桐生市の歯医者）",
    description: "今泉歯科医院（桐生市）へのよくある質問。予約・急患・駐車場・土曜診療・支払い方法・保険・お子さま連れ・英語対応・訪問診療などをまとめました。",
  },
  {
    path: "/news",
    title: "お知らせ（桐生市の歯医者）",
  ...
  {
    path: "/column/denture-fit",
    title: "入れ歯が合わない・痛いときの調整と作り直し",
    description: "桐生市で入れ歯が合わない・痛いとお悩みの方へ。今泉歯科医院が、合わなくなる原因と放置のリスク、調整(リライニング)や作り直しの対応をやさしく解説します。",
  },
  {
    path: "/column/whitening-guide",
    title: "ホワイトニングは痛い？ホーム／オフィスの違い",
    description: "桐生市でホワイトニングを検討中の方へ。今泉歯科医院が、しみる仕組みと、オフィス／ホームホワイトニングの違い・選び方をやさしく解説します。",
  },
  {
    path: "/column/silver-to-ceramic",
    title: "銀歯を白くしたい：セラミックなど審美治療の選び方",
    description: "桐生市で銀歯を白くしたい方へ。今泉歯科医院が、銀歯のリスク（二次むし歯・金属アレルギー）とセラミック等の選び方を正直に解説します。",
  },
  {
    path: "/column/cavity-stages",
    title: "むし歯は削るしかない？進行度別の治療法",
    description: "桐生市でむし歯が気になる方へ。今泉歯科医院が、むし歯の進行度（C0〜C4）ごとの治療法と、削らずに済むケースをやさしく解説します。",
  },
  {
    path: "/column/oral-surgery-scope",
    title: "親知らず以外の抜歯・口腔外科でできること",
    description: "桐生市で口腔外科をお探しの方へ。今泉歯科医院が、親知らず以外に口腔外科で対応できること（外傷・嚢胞・粘膜の異常など）を解説します。",
  },
  {
    path: "/column/cleaning-frequency",
    title: "歯のクリーニング（PMTC）の頻度の目安",
    description: "桐生市で歯のクリーニングをお考えの方へ。今泉歯科医院が、毎日磨いても汚れが残る理由と、PMTCの効果・通う頻度の目安を解説します。",
  },
  {
    path: "/column/brushing-floss",
    title: "正しい歯みがき・フロス／歯間ブラシの使い方",
    description: "桐生市で予防歯科に取り組みたい方へ。今泉歯科医院が、歯ブラシだけでは落ちない汚れと、フロス・歯間ブラシの使い分け・使い方を解説します。",
  },
  {
    path: "/column/fluoride",
    title: "フッ素は虫歯予防にどう効く？",
    description: "桐生市で虫歯予防をしたい方へ。今泉歯科医院が、フッ素の3つの働き（再石灰化・歯質強化・抗菌）と、ご家庭での効果的な使い方を解説します。",
  },
  {
    path: "/column/checkup",
    title: "定期検診はなぜ必要？通う頻度の目安",
    description: "桐生市でかかりつけ歯科をお探しの方へ。今泉歯科医院が、定期検診の必要性と通う頻度の目安、検診の内容を解説します。",
  },
  {
    path: "/column/kids-first-visit",
    title: "子どもの歯医者デビューは何歳から？嫌がる子への接し方",
    description: "桐生市で子どもの歯医者をお探しの方へ。今泉歯科医院が、歯医者デビューの目安と、嫌がるお子さまへの接し方（TSD法）をやさしく解説します。",
  },
  {
    path: "/column/home-visit-care",
    title: "通院が難しい方へ：訪問歯科でできること",
    description: "桐生市で訪問歯科をお探しのご家族・ケアマネージャー様へ。今泉歯科医院が、訪問歯科でできることと口腔ケアの大切さを解説します。",
  },
  {
  ...
  {
    path: "/column/gum-disease",
    title: "歯ぐきから血が出る・腫れる…歯周病のサインかも",
    description: "桐生市で歯ぐきの出血・腫れが気になる方へ。今泉歯科医院が歯周病のサインと原因、自宅でできるケア、受診の目安をやさしく解説します。土曜診療・駐車場完備。",
  },
  {
    path: "/column/bad-breath",
    title: "口臭が気になる…原因と自分でできる対策",
    description: "桐生市で口臭が気になる方へ。今泉歯科医院が口臭の主な原因（歯周病・舌苔など）と自分でできる対策、受診の目安を解説します。口臭外来あり。土曜診療・駐車場完備。",
  },
  {
    path: "/facility-standards",
    title: "施設基準・院内掲示事項",
    description:
