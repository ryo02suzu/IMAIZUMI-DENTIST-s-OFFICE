    ...
    <section id="contact" className="py-16 bg-white scroll-mt-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="bg-[#f8fbfc] rounded-lg p-6 mb-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <a href={BOOKING_PATH} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#f5a623] text-white px-6 py-2 rounded-full text-sm hover:bg-[#e0961c] transition-colors">WEB予約</a>
              </div>
            </div>
          ...
          >
            <img loading="lazy" decoding="async" src={`${import.meta.env.BASE_URL}clinic-exterior.jpeg`} alt="今泉歯科医院 外観" className="w-full h-full object-cover" />
          </motion.div>
        </div>
      </div>
    </section>
