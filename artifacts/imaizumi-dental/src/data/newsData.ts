...
export const newsItems: NewsItem[] = [
  {
    id: "closure-april-2-afternoon",
    date: "2026.03.25",
    datetime: "2026-03-25",
    category: "休診案内",
    title: "4/2(木) 午後休診のお知らせ",
    excerpt: "4月2日(木)は午後の診療を休診させていただきます。なお木曜午前は通常通り往診のため、終日医院での診療はございません。ご迷惑をおかけして申し訳ございません。",
    body: "4月2日(木)は午後の診療を休診させていただきます。\n\nなお、木曜日の午前は往診のため医院での診療は行っておりません。4月2日は終日、医院での診察はございませんのでご注意ください。\n\nご迷惑をおかけして誠に申し訳ございません。\n\nご予約・お問い合わせはお電話（0277-54-9893）にてお気軽にご連絡ください。",
  },
  {
