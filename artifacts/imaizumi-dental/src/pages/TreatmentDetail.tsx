...
const treatments: Treatment[] = [
  ...
  },
  {
    ...
    price: [
      ...
      { label: "金属床義歯（税込）", isHeader: true },
      { label: "金属床義歯", amount: "¥220,000~¥385,000", note: "上顎の部分を薄い金属で製作。喋りやすく、食べ物の温度がしっかり伝わる快適な入れ歯。" },
    ],
    faq: [
  ...
  },
  {
    ...
    features: [
      { title: "長期保証（5年〜10年）", body: "定期検診にお越しいただいている方を対象に、万が一の破損・脱離の際の無償修理・再製作を保証します。定期検診あり：10年保証 / なし：5年保証。" },
      { title: "ファイバーコア（土台）代込み", body: "歯を長持ちさせるために不可欠な高精度の土台（ファイバーコア）の費用も上記料金に含まれています。別途費用はかかりません。" },
      { title: "精密な適合へのこだわり", body: "拡大鏡・マイクロスコープを使用し、ミクロン単位の適合精度を追求することで、むし歯の再発リスクを最小限に抑えます。" },
    ],
    steps: [
      { num: "01", title: "カウンセリング・診査", body: "気になる部位・ご希望の仕上がり・ご予算をうかがい、最適なプランをご提案します。" },
      { num: "02", title: "歯の形成・型取り", body: "治療箇所を整え、精密な型取りを行います。" },
      { num: "03", title: "仮歯の装着", body: "技工所で製作する間、仮歯をつけて過ごしていただきます（約1〜2週間）。" },
      { num: "04", title: "セラミック装着・完成", body: "完成したものをお口に合わせて調整・装着して完了です。" },
    ],
    price: [
      { label: "詰め物（インレー）※価格は税込", isHeader: true },
      { label: "ハイブリッド・インレー 【コスト重視】", amount: "¥33,000~", note: "セラミック＋プラスチック混合素材。白く仕上がるが経年変色あり。" },
      { label: "ジルコニア・インレー 【強度重視】", amount: "¥44,000~", note: "ダイヤモンドに近い強度。強い力がかかる奥歯に最適。" },
      { label: "e.max・インレー 【美しさ重視】", amount: "¥55,000~", note: "ガラスセラミック製。天然歯のような透明感。笑顔で見える部位におすすめ。" },
      { label: "ゴールド・インレー 【長持ち重視】", amount: "¥77,000~", note: "18金使用。歯との隙間ができにくく、最も二次むし歯になりにくい素材。" },
      { label: "被せ物（クラウン）※価格は税込", isHeader: true },
      { label: "フルジルコニア 【コスパNo.1】", amount: "¥88,000~", note: "全てジルコニアで製作。高強度で奥歯のスタンダードとして最も選ばれている素材。" },
      { label: "e.max・クラウン 【自然な透明感】", amount: "¥99,000~", note: "全てガラスセラミック製。金属ゼロで歯茎の黒ずみなし。自然で透明感ある仕上がり。" },
      { label: "ジルコニア・ステイン 【奥歯の審美】", amount: "¥110,000~", note: "ジルコニアに特殊な色付けを施し、本物の歯に近いグラデーションを再現。" },
      { label: "白金加金(PGA)クラウン 【噛み合わせ保護】", amount: "¥132,000~", note: "適度な硬さで対合歯を傷めない。密着性が高く土台の歯を最も守る素材。" },
      { label: "ジルコニア・ボンド 【前歯の最高峰】", amount: "¥143,000~", note: "ジルコニアフレームに熟練技工士がセラミックを積層。前歯の光の透過性を完全再現。" },
      { label: "その他の審美処置※価格は税込", isHeader: true },
      { label: "ダイレクトボンディング", amount: "¥33,000~¥55,000", note: "型取り不要。高精度な樹脂を直接盛り付けて、すきっ歯や小さな虫歯をその日のうちに治します。" },
      { label: "ラミネートベニア", amount: "¥110,000~¥132,000", note: "前歯の表面をわずかに削り、薄いセラミックを貼り付ける「歯のネイル」のような処置。見た目を大きく改善します。" },
    ],
    faq: [
      { q: "どの素材を選べばよいかわかりません。", a: "前歯には透明感のあるe.max・クラウンやジルコニア・ボンドが人気です。奥歯には強度の高いフルジルコニアやジルコニア・ステインがおすすめです。詰め物（インレー）は奥歯ならジルコニア、見た目重視ならe.maxをよく選ばれています。診察時に歯の位置・噛み合わせ・ご予算をうかがってご提案します。" },
      { q: "保証の条件を教えてください。", a: "当院指定の定期検診（メンテナンス）にお越しいただいている方は10年保証、定期検診なしの方は5年保証となります。万が一の破損・脱離の際は無償で修理・再製作いたします。" },
      { q: "料金は表示価格だけで済みますか？", a: "ファイバーコア（土台）代は料金に含まれており、別途費用はかかりません。症例によってその他費用が必要な場合は、治療前に必ず総額のお見積りをご案内します。" },
      { q: "まずは相談だけでも大丈夫ですか？", a: "もちろんです。費用や素材の違いを聞いてから、ゆっくりご検討いただけます。お気軽にご来院ください。" },
    ],
  },
  {
    slug: "oral-surgery",
  ...
  },
  {
    ...
    price: [
      { label: "ホームホワイトニング", isHeader: true },
      { label: "上下全顎", amount: "¥27,500", note: "マウスピース・薬剤セット含む" },
      { label: "片顎", amount: "¥16,500", note: "マウスピース・薬剤セット含む" },
      { label: "オフィスホワイトニング", isHeader: true },
      { label: "上下全顎（2回）", amount: "¥27,500" },
      { label: "片顎", amount: "¥16,500" },
      { label: "セット・追加オプション", isHeader: true },
      { label: "完了コース（ホーム＋オフィス）", amount: "¥55,000" },
      { label: "ホームジェル（1本追加）", amount: "¥3,300" },
      { label: "ホームトレー再製（上下）", amount: "¥13,200" },
    ],
    faq: [
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="bg-[#f5a623] text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-[#e09520] transition-colors"
              >
                WEB予約はこちら
              </a>
              <a
