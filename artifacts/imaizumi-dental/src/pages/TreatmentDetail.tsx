...
const treatments: Treatment[] = [
  ...
  },
  {
    ...
    features: [
      { title: "すべてメタルフリー素材", body: "当院の自費診療では、金属を使わないメタルフリー素材を採用しています。金属アレルギーの方にも安心してお選びいただけます。" },
      { title: "無理な高額治療はしません", body: "患者さんのご予算・ご希望をしっかりうかがった上でご提案します。必要以上に高額な治療をおすすめすることはありません。" },
      { title: "治療前に総額お見積り", body: "治療を始める前に必ず総額のお見積りをお渡しします。「思ったより高かった」ということがないよう、ご納得いただいてから進めます。" },
    ],
    steps: [
    ...
    price: [
      { label: "白いつめ物（インレー）", isHeader: true },
      { label: "スタンダード", amount: "33,000円〜（税込）", note: "強度重視のジルコニア。費用を抑えて白くしたい方に。保証3年間。" },
      { label: "プレミアム", amount: "55,000円〜（税込）", note: "見た目と強度のバランスプラン。天然歯になじむ透明感。保証5年間。" },
      { label: "オーダーメイド", amount: "88,000円〜（税込）", note: "複雑な色調まで再現。隣の歯との調和を特に重視したい方に。保証10年間。" },
      { label: "白いかぶせ物（クラウン）", isHeader: true },
      { label: "エコノミー", amount: "44,000円〜（税込）", note: "フルジルコニア使用。強度重視で費用を抑えたい方に。保証3年間。" },
      { label: "スタンダード", amount: "88,000円〜（税込）", note: "当院おすすめのバランスプラン。前歯から奥歯まで対応。保証5年間。" },
      { label: "プレミアム", amount: "132,000円〜（税込）", note: "審美性を追求。色味を細かく調整し、より自然で美しい仕上がりに。保証10年間。" },
    ],
    faq: [
      { q: "料金は表示価格だけで済みますか？", a: "症例により別途費用が必要な場合がありますが、必ず治療前に総額のお見積りをご案内します。" },
      { q: "どの素材が自分に合うかわかりません。", a: "歯の位置や噛む力、ご予算によって最適なものは異なります。診察時に詳しくご説明しますのでご安心ください。" },
      { q: "保証の条件はありますか？", a: "保証適用には、当院指定の定期検診（メンテナンス）の受診が必要です。詳しくはご来院時にご確認ください。" },
