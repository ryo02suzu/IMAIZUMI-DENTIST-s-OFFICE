...
const faqs = [
  ...
  {
    q: "受診することが恥ずかしいのですが…",
    a: "口臭は多くの方が抱えるお悩みです。当院では個室での対応を基本とし、プライバシーに配慮した環境でご相談いただけます。どうぞ遠慮なくお越しください。",
  },
  {
    q: "他の病気が原因の場合はありますか？",
...
export default function BreathCarePage() {
  useSEO({
    title: "口臭外来 | 今泉歯科医院",
    description: "群馬県桐生市の今泉歯科医院・口臭外来。専用測定器による精密口臭検査（¥5,500〜）と舌クリーニング・専門処置で口臭の根本原因を科学的に解決します。一人で悩まず、まずご相談ください。",
  })
